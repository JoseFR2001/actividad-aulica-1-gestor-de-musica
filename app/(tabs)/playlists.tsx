        ...
        <View style={styles.container}>
            ...
            <FlatList
                ...
                renderItem={({ item, index }) => {
                    ...
                    return (
                        <Link
                            href={{ pathname: '/playlists/[id]', params: { id: item.id } }}
                            asChild
                        >
                            <Pressable style={[styles.card, { borderColor: accent + '66' }]}>
                                ...
                                <View style={styles.info}>
                                    ...
                                    <View style={styles.footer}>
                                        ...
                                        {item.creadaPorUsuario ? <Text style={styles.tag}>Tu lista</Text> : <Text style={styles.tag}>Curada</Text>}
                                    </View>
                                </View>
                            </Pressable>
                        </Link>
                ...
                ListEmptyComponent={<Text style={styles.empty}>No hay playlists disponibles.</Text>}
            />
        </View>
    );
}
